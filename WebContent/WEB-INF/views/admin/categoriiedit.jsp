...
<title>EurovendingEditPrimaryCategory</title>
...
<table id="Stable" class="center" >
 <caption style="color: Tomato" >Vizualizare/Editare Categorie</caption>
  ...
  <tr>
    ...
    <th>Statut Categorie</th>
       ...
       <form:form action="update-categorie-parinte.htm?id=${categorie.id}" metod="post" commandName="categorieParinte">
    <tr> 
